...
urlpatterns = [
    ...
    path("task/<int:task_id>/owner/<int:user_id>", ModifyTaskOwnerView.as_view(), name="task_item_owner"),
    path("task/<int:task_id>/completed", ModifyTaskStatusView.as_view(), name="task_item_status"),
    path("task/<int:task_id>/comment", AddCommentView.as_view(), name="task_item_comment"),
    ...
    path('time/last-month', TimerLogLastMonthView.as_view(), name='task_timers_last_month'),
    path('tasks/top-20', Top20TasksView.as_view(), name='top_task_list'),
    path("tasks/<str:q>", SearchTaskView.as_view(), name="search_tasks"),
